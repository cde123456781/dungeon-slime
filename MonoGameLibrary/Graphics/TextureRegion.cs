...
public class TextureRegion
{
    ...
    /// <summary>
    /// Creates a new texture region according to the supplied parameters
    /// </summary>
    /// <param name="texture">The texture to use as the source texture</param>
    /// <param name="x">The x coordinate of the upper left</param>
    /// <param name="y">The y coordinate of the upper left</param>
    ...
    /// <param name="position">The coordinates to draw this texture region</param>
    /// <param name="colour"></param>
    public void Draw(SpriteBatch spriteBatch, Vector2 position, Color colour)
    {
        Draw(spriteBatch, position, colour, 0.0f, Vector2.Zero, Vector2.One, SpriteEffects.None, 0.0f);
    }
    ...
    /// <param name="effects">Specifies if this texture region should be flipped horizontally, vertically, or both when drawing on screen.</param>
    /// <param name="layerDepth">The depth of the layer to use when drawing this texture region on screen.</param>
    public void Draw(SpriteBatch spriteBatch, Vector2 position, Color colour, float rotation, Vector2 origin, Vector2 scale, SpriteEffects effects, float layerDepth)
    {
        spriteBatch.Draw(
            Texture,
            position,
